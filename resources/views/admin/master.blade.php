        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav metismenu" id="side-menu">
                    ...
                    <li>
                        <a href="/admin"><i class="fa fa-users"></i> <span class="nav-label">Home</span></a>
                    </li>
                    <li>
                        <a href="/admin/users"><i class="fa fa-users"></i> <span class="nav-label">Usuários</span></a>
                    </li>
                    <li>
                        <a href="/admin/freelancers"><i class="fa fa-users"></i> <span class="nav-label">Freelancer</span></a>
                    </li>
                    <li>
                        <a href="/admin/graphs"><i class="fa fa-users"></i> <span class="nav-label">Gráficos</span></a>
                    </li>
                    <li>
                        <a href="/admin/reports"><i class="fa fa-users"></i> <span class="nav-label">Relatórios</span></a>
                    </li>
